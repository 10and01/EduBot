...
class AgentDefaults(Base):
    ...
    workspace: str = "D:\\EduBot\\.nanobot\\workspace"
...
class VectorDBConfig(Base):
    """Local vector database configuration for document retrieval."""

    provider: Literal["chroma"] = "chroma"
    path: str = "documents/chroma"
    collection: str = "lesson_materials"
    top_k: int = 5


class MediaAPIConfig(Base):
    """External media generation API configuration."""
...
class LessonPlanConfig(Base):
    """Lesson-plan generation defaults."""
...
class EducationConfig(Base):
    """Education bot feature configuration."""

    enabled: bool = True
    vectors: VectorDBConfig = Field(default_factory=VectorDBConfig)
    media: MediaAPIConfig = Field(default_factory=MediaAPIConfig)
    lesson_plan: LessonPlanConfig = Field(default_factory=LessonPlanConfig)
    materials_dir: str = "documents/materials"
    auto_import_materials: bool = True
